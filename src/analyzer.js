const analyzer = {
  ...
  getAverageWordLength: (text) => {
    ...
    const totalOfCharactersWithoutSpace = text
      .replace(/\s+/g, "")
      .trimStart()
      .trimEnd()
      .split("");

    const totalOfCharacters = totalOfCharactersWithoutSpace.length;

    const divisionOfTotals = totalOfCharacters / wordsCount;
  ...
  getNumberSum: (text) => {
    ...
    const roundedSum = Math.round(numberSum * 100) / 100;
